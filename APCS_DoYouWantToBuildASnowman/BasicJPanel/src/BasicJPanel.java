...
public class BasicJPanel extends JPanel{
    ...
    */
    public void paintComponent(Graphics g){
        g.drawLine(100,100,0,450); // Draw a line from (10,10) to (150,150)
        g.drawOval(200, 50, 100,100); //top part
        g.drawOval(175, 150, 150, 150);//middle part
        g.drawOval(150, 300,200,200);//bottom part
        g.drawOval(230, 75, 10,10); //left eye
        g.drawOval(260, 75, 10,10);//right eye
        g.drawOval();
    }
